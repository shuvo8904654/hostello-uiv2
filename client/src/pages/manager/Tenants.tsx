...
export default function ManagerTenants() {
  return (
    <DashboardLayout type="manager">
      <div className="mb-8">
        <h2 className="text-3xl font-bold tracking-tight">Tenant Management - Dhaka Hub</h2>
        <p className="text-muted-foreground">View and manage tenants for your assigned branch.</p>
      </div>
